...
cursor= tweepy.Cursor(api.user_timeline,screen_name="@PlayStation", count =200, tweet_mode="extended").items(1)
...
map.save("C:\\Users\\juanp\\OneDrive\\Escritorio\\Nueva carpeta\\ProyectoModelos\\mapa.html")
